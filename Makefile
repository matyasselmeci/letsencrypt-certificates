# Auto-generated Makefile from certificate table
# Regenerate with: python3 generate-makefile.py certificates.csv
...
targets = 6187b673.signing_policy 4042bcee.signing_policy \
          8794b4e3.signing_policy 0b9bc432.signing_policy \
          bae39ced.signing_policy 462422cf.signing_policy \
          f7679d31.signing_policy 9aad238c.signing_policy \
          09e5bea5.signing_policy aa578057.signing_policy \
          4cdd6f92.signing_policy 31dfb39d.signing_policy \
          9f308661.signing_policy 67561239.signing_policy \
          3e7e99ec.signing_policy 507754fb.signing_policy \
          35b815f3.signing_policy d0a3aef2.signing_policy \
          93120419.signing_policy aa76c4ab.signing_policy \
          27794265.signing_policy 4260b799.signing_policy \
          36f5bce7.signing_policy 137e9a94.signing_policy \
          ...
          6187b673.0 4042bcee.0 \
          8794b4e3.0 0b9bc432.0 \
          bae39ced.0 462422cf.0 \
          f7679d31.0 9aad238c.0 \
          09e5bea5.0 aa578057.0 \
          4cdd6f92.0 31dfb39d.0 \
          9f308661.0 67561239.0 \
          3e7e99ec.0 507754fb.0 \
          35b815f3.0 d0a3aef2.0 \
          93120419.0 aa76c4ab.0 \
          27794265.0 4260b799.0 \
          36f5bce7.0 137e9a94.0 \
...
6187b673.signing_policy 4042bcee.signing_policy : isrgrootx1.signing_policy
	$(LINK) $< $@
8794b4e3.signing_policy 0b9bc432.signing_policy : isrg-root-x2.signing_policy
	$(LINK) $< $@
bae39ced.signing_policy 462422cf.signing_policy : lets-encrypt-e5.signing_policy
	$(LINK) $< $@
f7679d31.signing_policy 9aad238c.signing_policy : lets-encrypt-e6.signing_policy
	$(LINK) $< $@
09e5bea5.signing_policy aa578057.signing_policy : lets-encrypt-r10.signing_policy
	$(LINK) $< $@
4cdd6f92.signing_policy 31dfb39d.signing_policy : lets-encrypt-r11.signing_policy
	$(LINK) $< $@
9f308661.signing_policy 67561239.signing_policy : lets-encrypt-e7.signing_policy
	$(LINK) $< $@
3e7e99ec.signing_policy 507754fb.signing_policy : lets-encrypt-e8.signing_policy
	$(LINK) $< $@
35b815f3.signing_policy d0a3aef2.signing_policy : lets-encrypt-e9.signing_policy
	$(LINK) $< $@
93120419.signing_policy aa76c4ab.signing_policy : lets-encrypt-r12.signing_policy
	$(LINK) $< $@
27794265.signing_policy 4260b799.signing_policy : lets-encrypt-r13.signing_policy
	$(LINK) $< $@
36f5bce7.signing_policy 137e9a94.signing_policy : lets-encrypt-r14.signing_policy
	$(LINK) $< $@
...
6187b673.0 4042bcee.0 : isrgrootx1.pem
	$(LINK) $< $@
8794b4e3.0 0b9bc432.0 : isrg-root-x2.pem
	$(LINK) $< $@
bae39ced.0 462422cf.0 : lets-encrypt-e5.pem
	$(LINK) $< $@
f7679d31.0 9aad238c.0 : lets-encrypt-e6.pem
	$(LINK) $< $@
09e5bea5.0 aa578057.0 : lets-encrypt-r10.pem
	$(LINK) $< $@
4cdd6f92.0 31dfb39d.0 : lets-encrypt-r11.pem
	$(LINK) $< $@
9f308661.0 67561239.0 : lets-encrypt-e7.pem
	$(LINK) $< $@
3e7e99ec.0 507754fb.0 : lets-encrypt-e8.pem
	$(LINK) $< $@
35b815f3.0 d0a3aef2.0 : lets-encrypt-e9.pem
	$(LINK) $< $@
93120419.0 aa76c4ab.0 : lets-encrypt-r12.pem
	$(LINK) $< $@
27794265.0 4260b799.0 : lets-encrypt-r13.pem
	$(LINK) $< $@
36f5bce7.0 137e9a94.0 : lets-encrypt-r14.pem
	$(LINK) $< $@
